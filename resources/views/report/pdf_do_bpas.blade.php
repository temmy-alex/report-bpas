...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h1 class="bold" style="margin-bottom: 0.5em; color: black;  font-size: 2.1em; float:right; margin-top: 0em;">DELIVERY ORDER</h1>
        ...
        <div class="col-md-10">
            <table class="table-invoice-info">
                <tr>
                    <td class="bold">TO</td>
                    <td class="bold">:</td>
                    <td class="bold">PT. PLAZA INDONESIA REALTY TBK</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td class="bold"> The Plaza Office Tower LT 10,</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td class="bold">JL MH Thamrin Kav 28-30</td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
                    <td class="bold">Menteng, Jakarta Pusat</td>
                </tr>
                <tr>
                    <td class="bold">UP</td>
                    <td class="bold">:</td>
