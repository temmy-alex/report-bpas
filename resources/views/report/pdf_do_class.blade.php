...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <h1 class="bold" style="margin-bottom: 0.5em; color: black; margin-left: 0.7em; font-size: 3.5em;">DELIVERY ORDER</h1>
            <table class="table-invoice-info">
                ...
                <tr>
                    <td class="bold text-right" style="white-space: nowrap;">DO NO</td>
                    <td class="dotted-border bold">00001/BPAS/III/2023</td>
                </tr>
                <tr>
                    <td class="bold text-right">PIC</td>
                    <td class="dotted-border bold"></td>
                </tr>
                <tr>
                    <td class="bold text-right">PO CUSTOMER</td>
                    <td class="dotted-border bold"></td>
                </tr>
    ...
    <div class="row">
        <div class="col-md-6">
            <p class="bold">TO : PT. PLAZA INDONESIA REALTY TBK The Plaza Office Tower LT 10 JL MH Thamrin Kav 28-30 Menteng, Jakarta Pusat </p>
            <p class="pt-info bold">UP : Bpk.Harto (081384390745)</p>
            <p class="pt-info bold">TELP : 021-5265161</p>
        </div>
            ...
            <div class="col-md-12">
                <div style="margin-top: 3em;">
                    ...
                    <table class="table-product">
                        ...
                        @endfor
                        <tr>
                            <th class="pt-info bold">NOTES</th>
                            <th class="pt-info bold">Barang tersebut diatas diterima dalam keadaan baik dan jumlah yang sesuai.</th>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div style="margin-top: 1.3em;">
                    <h5 class="bold">PT.BUANA PRIMALITE ABADI SUKSES</h5>
                </div>
            </div>
            <div class="col-md-4">
                <div style="margin-top: 1.3em;">
                    <h5 class="bold">PENERIMA</h5>
                </div>
            </div>
        </div>
